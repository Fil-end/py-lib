...
from Pd100_surface_Env import MCTEnv
...
env = MCTEnv(save_dir = 'save_dir', save_every= 20 ,timesteps = 600, reaction_H = 112690, reaction_n = 32)
random.seed(0)
np.random.seed(0)
# env.seed(0)
torch.manual_seed(0)
...
return_list = rl_utils.train_off_policy_agent(env, agent, num_episodes, 100,
                                              replay_buffer, minimal_size,
                                              batch_size, log_dir, load_pkl = True)
